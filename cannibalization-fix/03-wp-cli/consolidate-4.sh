#!/bin/bash
# CONSOLIDATE #4: software-gestion-negocios-la-romana → software-gestion-negocios-la-vega
...
WINNER_ID=$(wp post list --post_name="software-gestion-negocios-la-vega" --post_type=post --fields=ID --format=ids 2>/dev/null)
...
# wp post meta update $LOSER_ID _yoast_wpseo_redirect "https://xn--gestindo-z3a.com/belleza-bienestar/software-gestion-negocios-la-vega/"
