#!/bin/bash
# CONSOLIDATE #11: software-reservaciones-salon-belleza-punta-cana → software-reservaciones-salon-belleza-la-romana
...
WINNER_ID=$(wp post list --post_name="software-reservaciones-salon-belleza-la-romana" --post_type=post --fields=ID --format=ids 2>/dev/null)
...
# wp post meta update $LOSER_ID _yoast_wpseo_redirect "https://xn--gestindo-z3a.com/belleza-bienestar/software-reservaciones-salon-belleza-la-romana/"
