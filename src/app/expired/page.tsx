    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-ink-950 px-4 text-center">
      ...
      <div className="relative max-w-md">
        ...
        <p className="mt-4 text-zinc-400">
          La suscripción de{" "}
          <span className="font-medium text-white">{businessName}</span> ha
          vencido y el servicio de reservas está temporalmente desactivado.
        </p>
        <p className="mt-2 text-sm text-zinc-500">
          Si eres el dueño del negocio, contacta a Bookido para renovar tu plan
          y reactivar tu página.
        </p>
        ...
        >
          ...
          Renovar suscripción por WhatsApp
        </a>
      </div>
    </div>
  );
